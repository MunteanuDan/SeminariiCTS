...
public class DepartamentFinanciarEager {
	...
	private static DepartamentFinanciarEager departamentFinanciarEager = new DepartamentFinanciarEager(10,"Popescu", 3000); // initializam aici ca sa fie Singleton
	...
	public static DepartamentFinanciarEager getInstance() { // aceasta functie doar returneaza instanta
